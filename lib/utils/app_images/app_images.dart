class AppImages {
  ...
  static const String ourMissionImage = "$basePath/ourMissionImage.png";
  static const String onboardingOne = "$basePath/onboardingOne.png";
  static const String onboardingTwo = "$basePath/onboardingTwo.png";
  static const String onboardingThree = "$basePath/onboardingThree.png";
  ...
  static const String logo2 = "$basePath/logo.png";
  static const String home = "$basePath/home.svg";
  static const String camara = "$basePath/camara.svg";
  ...
  static const String appleIcon = "$basePath/appleIcon.svg";
